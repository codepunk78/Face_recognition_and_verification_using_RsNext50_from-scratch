...
import random
import shutil
from p1 import TRAIN_SET_RATIO, TEST_SET_RATIO
    ...
    def __get_all_file_path(self):
        ...
        for file_type in self.__get_label_names():
            ...
            for file in os.listdir(type_file_path):
                ...
                for img in os.listdir(single_file_path):
                    img_path=os.path.join(single_file_path, img)
...
if __name__ == '__main__':
    split_dataset = SplitDataset(dataset_dir="/home/boot/Desktop/face_verification_and_recognition/trainset",
